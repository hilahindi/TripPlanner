...
The full round-trip route starting and ending at this point should be up to 15 kilometers in total.
...
// Using Groq API for AI model interaction
  ...
  return [parsed.start.lng, parsed.start.lat]; // Return the coordinates in [lng, lat] format for OpenRouteService compatibility
}
